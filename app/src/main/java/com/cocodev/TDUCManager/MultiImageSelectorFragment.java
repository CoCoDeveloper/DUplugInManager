...
import com.cocodev.TDUCManager.Gallery.Adapters.FolderAdapter;
import com.cocodev.TDUCManager.Gallery.Adapters.ImageGridAdapter;
import com.cocodev.TDUCManager.Gallery.Listeners.FolderOnItemClickListener;
import com.cocodev.TDUCManager.Gallery.Listeners.ImageOnItemClickListener;
import com.cocodev.TDUCManager.Gallery.Models.Folder;
import com.cocodev.TDUCManager.Gallery.Models.Image;
import com.cocodev.TDUCManager.Gallery.Utils.FileUtils;
import com.cocodev.TDUCManager.Gallery.Utils.ScreenUtils;
            ...
            if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
                ...
                if (mTmpFile != null && mTmpFile.exists()) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                        imgPathUri = FileProvider.getUriForFile(getActivity(), getActivity().getPackageName() + ".provider", mTmpFile);
                    } else {
